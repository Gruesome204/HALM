...
public class TU_ChoiceElementBehavior
{
        ...
        int level, TurretUpgradeChoiceSO choiceSO, TurretUpgradeChoiceSO.UpgradeOption _option)
    {
        ...
        choiceElement.Q<Label>("name").SetBinding("text", new LocalizedString("TurretUpgradeTranslationTable", $"{option.displayName}"));

        choiceElement.Q<Label>("description").SetBinding("text", new LocalizedString("TurretUpgradeTranslationTable", $"{option.displayName}Description"));
